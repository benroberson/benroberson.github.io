...
if (queryString === "?nocount")
	urlString = "https://api.countapi.xyz/get/utkbrobers3/views";
else
	urlString = "https://api.countapi.xyz/hit/utkbrobers3/views";
...
function reset() {
	...
	xhr1.open("GET", "https://api.countapi.xyz/set/utkbrobers3/views?value=0");
